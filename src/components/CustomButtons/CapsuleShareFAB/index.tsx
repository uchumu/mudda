...
const CapsuleShareFAB = ({ code }: Props) => {
  ...
  return (
    <div className="fixed top-0 w-full max-w-[480px] h-full pointer-events-none">
      <div
        className="w-[56px] h-[56px] bg-white absolute z-50 right-[22px] bottom-[108px] pointer-events-auto cursor-pointer rounded-full shadow-md flex items-center justify-center"
        onClick={onClick}
      >
        <IconShare />
      </div>
