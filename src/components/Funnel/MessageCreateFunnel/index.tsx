...
import CapsuleProgress from "@/components/Progress/CapsuleProgress";
...
const MessageCreateFunnel = ({
  ...
  return (
    <div className="w-full h-full">
      ...
      <CapsuleProgress max={steps.length} current={focusedStepIndex} />
...
export default MessageCreateFunnel;
